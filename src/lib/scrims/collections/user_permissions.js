...
class ScrimsUserPermissionsCollection {
    ...
    resolvePosition(positionResolvable) {
        return this.client.positions.cache.find(ScrimsPosition.resolve(positionResolvable));
    }
    ...
    /** @param {ScrimsPermissionData} permissions */
    set(permissions) {
        this.setUserPositions(permissions.getUserPositions(this.userId))
        return this;
    }

    /** @param {ScrimsUserPosition[]} userPositions */
...
module.exports = ScrimsUserPermissionsCollection;